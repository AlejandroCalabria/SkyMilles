...
<%
    ...
    if(nuts != null && nuts.length != 0){
       for(int i = 0; i < nuts.length; i++){
           con.removerElemento(Integer.parseInt(nuts[i]));
       }
       out.println("<script type='text/javascript'>");
       out.println("alert('Nutrientes removidos com sucesso!')");
       out.println("</script>");
    }
%>
<html lang="en">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box_text">
                                        ...
                                        <form action="removerNutriente.jsp" method="POST">
                                        <table width="100%">
                                             <tr width="100%">
                                                <%
                                                    String linha = "";
                                                    ...
                                                    for (Elemento c : con.consultarElementos()) {
                                                        ...
                                                        linha += "<td><input type='checkbox' name='nuts' value='"+ c.getEleCodigo()+"'>" 
                                                                + "<label for='nuts'> " + c.getEleNome() + "</label>"
                                                                + "</td></tr>";
                                                        i++;
                                                    }
                                                    linha += "<tr><td colspan=2><input type='submit' value='Remover nutrientes cadastrados'></td></tr>";
                                                    out.println(linha);
                                                %>
