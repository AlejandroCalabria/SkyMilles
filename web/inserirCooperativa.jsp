...
<%
    ...
    if (coo != null) {
        Cooperativa ele = new Cooperativa(0, coo, cnpj, end, cid);
        con.inserirCooperativa(ele);
        out.println("<script type='text/javascript'>");
        out.println("alert('Cooperativa inserida com sucesso!')");
        out.println("</script>");
    }
%>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box_text">
                                        <h1>Gerenciamento de Cooperativa</h1>
                                        <form action="inserirCooperativa.jsp" method="POST">
                                            <table width="100%">
                                                <tr>
                                                ...
                                                <tr width="100%">
                                                    <td width="30%"><input name="coo" type="text"></td>
                                                    <td width="30%"><input name="end" type="text"></td>
                                                    <td width="20%"><input name="cnpj" type="text"></td>
                                                    <td width="20%"><input name="cid" type="text"></td>
                                                    <td width="20%"><input name="" type="submit"value="Inserir nova cooperativa"></th>
                                                </tr>
                                            </table>   
                                        </form>
                                    </div>
                            ...
                            <table width="100%">
                                ...
                                <%
                                    ...
                                    for (Cooperativa c : con.consultarCooperativas()) {
                                        ...
                                        linha += "<td>" + c.getCooNome() + "</td>";
                                        linha += "<td>" + c.getCooEndereco() + "</td>";
                                        linha += "<td>" + c.getCooCNPJ() + "</td>";
                                        linha += "<td>" + c.getCooCidade() + "</td></tr>";
                                    }
