...
<%
    ...
    if(pro != null){
        ...
        int coo = Integer.parseInt(request.getParameter("coo")); 
        Fabricante ele = new Fabricante(0, pro, end, coo, cont);
        con.inserirFabricante(ele);
        out.println("<script type='text/javascript'>");
        out.println("alert('Produtor inserido com sucesso!')");
        out.println("</script>");
    }
%>
<html lang="en">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box_text">
                                        ...
                                        <form action="inserirProdutor.jsp" method="POST">
                                        <table width="100%">
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="30%"><input name="pro" type="text"></td>
                                                <td width="30%"><input name="end" type="text"></td>
                                                <td width="30%"><input name="con" type="text"></td>
                                                <td width="20%"><select name='coo'>
                                                            <%
                                                                String f = "";
                                                                CooperativaControle cc = new CooperativaControle();
                                                                for (Cooperativa c : cc.consultarCooperativas()) 
                                                                    f += "<option value='"+c.getCooCodigo()+"'>"+c.getCooNome()+"</option>";
                                                                out.println(f);
                                                            %>
                                                         </select></td>
                                                <td width="20%">
                                                    <input type="submit" value='Inserir um novo produtor'>
                                                </td>
                                            </tr>
                                            <tr><td colspan='5'>                                                                             
