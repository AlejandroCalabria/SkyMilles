...
<%
    ...
    if(nome != null){
        ...
        for (Fabricante c : con.consultarFabricantes()) {
            Fabricante ele = new Fabricante(c.getFabCodigo(), request.getParameter("n"+i), request.getParameter("e"+i), Integer.parseInt(request.getParameter("c"+i)), request.getParameter("co"+i));
            con.alterarFabricante(ele);
            i++;
        }
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box_text">
                                             <h1>Alterar informações do Produtor</h1>
                                        <form action="alterarProdutor.jsp" method="POST">
                                        <table width="100%">
                                            <tr>
                                            ...
                                            <tr>
                                                <%
                                                    ...
                                                    for (Fabricante c : con.consultarFabricantes()) {
                                                        ...
                                                        linha += "<td><input type='text' name='n"+i+"' value='"+ c.getFabNome()+"'></td>";
                                                        linha += "<td><input type='text' name='e"+i+"' value='"+ c.getFabEndereco()+"'></td>";
                                                        linha += "<td><input type='text' name='co"+i+"' value='"+ c.getFabContato()+"'></td>";
                                                        linha += "<td><select name='c"+i+"'>";
                                                        CooperativaControle cc = new CooperativaControle();
                                                        for (Cooperativa f : cc.consultarCooperativas()) {
                                                            if(f.getCooCodigo() == c.getFabCooperativa())        
                                                                linha += "<option value='" + f.getCooCodigo() + "' selected>" + f.getCooNome() + "</option>";
                                                            else
                                                                linha += "<option value='" + f.getCooCodigo() + "'>" + f.getCooNome() + "</option>";
                                                        }   
                                                        i++;
                                                    }
                                                    linha += "<tr><td colspan=5><input type='submit' value='Alterar dados dos produtores'></td></tr>";
                                                    out.println(linha);
                                                %>
