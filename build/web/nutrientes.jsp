...
<%
    ...
    ArrayList<Elemento> res = con.consultarElementos();
%>
<html lang="en">
    <head>
        <!-- basic -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box_text_CRUD">
                            <h3>Gerenciamento de Nutrientes</h3>
                            <br><br><br><br>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box_text_principais_telas">
                                       <table style:"width:'80%'">
                                            <tr>
                                                ...
                                                <th style:"width:'40%'">Nutrientes</th>
                                                <th style:"width:'20%'">VD</th>
                                            </tr>
                                            <%
                                                String linha = "";
                                                for (Elemento c : res) {
                                                    linha += "<tr><td>" + c.getEleCodigo() + "</td>";
                                                    linha += "<td>" + c.getEleNome() + "</td>";
                                                    linha += "<td>" + c.getEleValorRecomendado()+ "</td></tr>";
                                                }
                                                //linha += "<tr><td colspan=3><a href='inserirNutriente.jsp'>Inserir novo nutriente</a>   |   <a href='alterarNutriente.jsp'>Alterar dados dos nutrientes</a>   |   <a href='removerNutriente.jsp'>Remover nutrientes cadastrados</a></td></tr>";
                                                out.println(linha);
                                            %>
                                            <tr><td colspan='3'>                                                                             
